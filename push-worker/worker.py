        ...
        try:
            ...
            for bid, b in broadcasts.items():
                ...
                sent, total = notifier.broadcast({
                    "title": b.get("title") or "منوعات الرحمان",
                    "body": b.get("body") or "",
                ...
                tg_text = f"🥩 *{b.get('title') or 'منوعات الرحمان'}*\n{b.get('body') or ''}"
                tg_sent = 0
